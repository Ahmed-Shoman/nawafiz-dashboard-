            ...
            <div className="space-y-6">
              ...
              <FadeIn direction="left" delay={0.15}>
                <div className="bg-primary rounded-3xl p-8 text-center">
                  ...
                  <a
                    href="/contact"
                    className="block w-full px-6 py-3.5 bg-accent text-accent-foreground font-bold rounded-xl hover:bg-accent/90 transition-colors shadow-lg text-center"
                  >
                    {lang === "ar" ? "تواصل معنا" : "Contact Us"}
                  </a>
                  <a
                    href={`https://wa.me/966537502035`}
                    target="_blank"
                ...
                <div className="bg-card border border-border rounded-3xl p-6">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li>
                      <a
                        href="/services"
                        className="flex items-center gap-2 text-primary font-semibold text-sm hover:text-accent transition-colors mt-2"
                      >
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="text-muted-foreground text-xs mt-1.5 line-clamp-2">
                    {lang === "ar" ? s.shortDescAr : s.shortDescEn}
                  </p>
                </div>
              </motion.a>
            ))}
